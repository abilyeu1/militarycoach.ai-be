...
exports.basePrompt_CW = void 0;
const basePrompt_CW = ({ name, age, branchOfService, languages, careers, educations, professionalCertificates, industryOfInterest, jobLocation, militaryRank, }) => {
    return `
...
exports.basePrompt_CW = basePrompt_CW;
//# sourceMappingURL=careerWizard.js.map