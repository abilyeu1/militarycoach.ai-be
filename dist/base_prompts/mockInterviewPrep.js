...
exports.basePrompt_MI = void 0;
const basePrompt_MI = ({ name, age, branchOfService, languages, careers, educations, professionalCertificates, industryOfInterest, jobPositionLevel, interviewFormat, militaryRank, jobPositionTitle, }) => {
  ...
  Also follow up the question response with the following pre-generated questions the member might ask. Start the follow up questions with ## and ${industryOfInterest !== null && industryOfInterest !== void 0 ? industryOfInterest : 'any'}, don't add industry ${industryOfInterest} in the helper question. These questions should be at the end of the response. There's no need to provide a sample response to these questions until prompted to. The questions are as follows:
...
exports.basePrompt_MI = basePrompt_MI;
//# sourceMappingURL=mockInterviewPrep.js.map